...
$allowOrigins= array(
    'https://lineapi.myanmaritc.com',  // API Domain
    'https://app.linedeli.com'  // Client domain
);
if(isset($_SERVER['HTTP_ORIGIN']) && $_SERVER['HTTP_ORIGIN'] !='' ){
    foreach($allowOrigins as $allowOrigin){
        if(preg_match('#'. $allowOrigin . '#' , $_SERVER['HTTP_ORIGIN'])){
            ...
            header('Access-Control-Allow-Headers: Origin,Content-Type, Accept, X-Auth-Token,Authorization,
